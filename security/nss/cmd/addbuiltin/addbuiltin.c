 ...
 *
 * $Id: addbuiltin.c,v 1.3.24.1 2002/04/10 03:24:16 cltbld%netscape.com Exp $
 */
...
printheader() {
    printf("# \n"
     ...
     "# GPL.\n"
     "#\n"
     "CVS_ID \"@(#) $RCSfile: addbuiltin.c,v $ $Revision: 1.3.24.1 $ $Date: 2002/04/10 03:24:16 $ $Name: MOZILLA_1_0_RELEASE $\"\n"
     "\n"
     "#\n"
     "# certdata.txt\n"
     "#\n"
