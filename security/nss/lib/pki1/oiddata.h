...
#ifdef DEBUG
static const char OIDDATA_CVS_ID[] = "@(#) $RCSfile: oiddata.h,v $ $Revision: 1.1.18.1 $ $Date: 2002/04/10 03:28:18 $ $Name: MOZILLA_1_0_RELEASE $ ; @(#) $RCSfile: oiddata.h,v $ $Revision: 1.1.18.1 $ $Date: 2002/04/10 03:28:18 $ $Name: MOZILLA_1_0_RELEASE $";
#endif /* DEBUG */
