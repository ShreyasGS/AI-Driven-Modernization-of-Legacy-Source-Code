 ...
 */
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $RCSfile: oiddata.c,v $ $Revision: 1.1.18.1 $ $Date: 2002/04/10 03:28:18 $ $Name: MOZILLA_1_0_RELEASE $ ; @(#) $RCSfile: oiddata.c,v $ $Revision: 1.1.18.1 $ $Date: 2002/04/10 03:28:18 $ $Name: MOZILLA_1_0_RELEASE $";
#endif /* DEBUG */
