...
#ifdef DEBUG
static const char PKIXM_CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/include/pkixm.h,v $ $Revision: 1.1.162.1 $ $Date: 2002/04/10 03:28:24 $ $Name: MOZILLA_1_0_RELEASE $";
#endif /* DEBUG */
