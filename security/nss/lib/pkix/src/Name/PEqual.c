...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/Name/PEqual.c,v $ $Revision: 1.1.162.1 $ $Date: 2002/04/10 03:28:41 $ $Name: MOZILLA_1_0_RELEASE $";
#endif /* DEBUG */
