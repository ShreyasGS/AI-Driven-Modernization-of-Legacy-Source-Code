 ...
 */
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $RCSfile: certdata.c,v $ $Revision: 1.14.12.1 $ $Date: 2002/04/10 03:26:49 $ $Name: MOZILLA_1_0_RELEASE $""; @(#) $RCSfile: certdata.c,v $ $Revision: 1.14.12.1 $ $Date: 2002/04/10 03:26:49 $ $Name: MOZILLA_1_0_RELEASE $";
#endif /* DEBUG */
...
static const NSSItem nss_builtins_items_0 [] = {
  ...
  { (void *)"NSS", (PRUint32)4 },
  { (void *)"@(#) $RCSfile: certdata.c,v $ $Revision: 1.14.12.1 $ $Date: 2002/04/10 03:26:49 $ $Name: MOZILLA_1_0_RELEASE $""; @(#) $RCSfile: certdata.c,v $ $Revision: 1.14.12.1 $ $Date: 2002/04/10 03:26:49 $ $Name: MOZILLA_1_0_RELEASE $", (PRUint32)179 }
};
#endif /* DEBUG */
