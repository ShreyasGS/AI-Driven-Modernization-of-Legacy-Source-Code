...
/**
 * Modernized implementation of nsTypedSelection::FetchStartOffset
 * 
 * This file demonstrates the modernization of the FetchStartOffset method
 ...
 * 3. Proper null checking with meaningful error codes
 ...
 * 
 * Returns the start offset of a range as a Result type that either
 * contains the offset value or an error code.
 * 
 * @param aRange - The range to get the start offset from
 * @return Result<PRInt32, nsresult> - Success: The start offset
 ...
 * 
 * @param aRange - The range to get the start offset from
 * @return PRInt32 - The start offset or 0 on error
 */
PRInt32
nsTypedSelection::FetchStartOffset(nsIDOMRange *aRange)
{
